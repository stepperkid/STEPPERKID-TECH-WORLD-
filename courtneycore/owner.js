...
async function ownerCommand(sock, chatId, message) {
    try {
        ...
        const ownerNumberRaw = '254743037984';
        ...
        const thumbnailUrl = 'https://i.ibb.co/nswZ9WcB/upload-1770456482848-a76a1a20-jpg.jpg'; // Your existing image now used as ad thumbnail
        ...
        const projectUrl = settings.githubUrl || settings.updateZipUrl || 'https://github.com/stepperkid254/TitanBot-Core-';
